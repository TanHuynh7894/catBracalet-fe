...
const Collection = () => {
    return (
        <section id="collection" className="py-32 bg-ivory">
            <div className="max-w-[1400px] mx-auto px-6 md:px-12">
                <div className="flex justify-between items-end mb-16">
                    <h2 className="text-4xl md:text-5xl font-serif text-wine">Bộ sưu tập nổi bật</h2>
                    <button className="hidden md:flex items-center gap-2 border border-wine/10 px-6 py-2 rounded-lg text-[10px] font-bold tracking-widest text-wine/60 hover:text-wine transition-all">
                    ...
                    {products.map((item, idx) => (
                        ...
                        >
                            <div className="relative aspect-[4/5] mb-6 overflow-hidden rounded-2xl luxury-shadow bg-cream">
                                ...
                                <button className="absolute bottom-4 right-4 text-wine/40 hover:text-wine transition-colors">
                                    <Heart size={18} />
                                </button>
                            </div>
